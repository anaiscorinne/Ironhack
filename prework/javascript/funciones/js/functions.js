...
// The function receives an eight-digit number and returns a single letter.
...
// 	var chr_count = []
// 	for (var x=0; x < array_words.length; x++) {
// 		chr_count.push(array_words[x].length)
// 		}
// 		chr_count.sort(function(a, b) {return b-a});
// 		return chr_count[0]
// 	}
...
// array_lengths.push( findLongestWord( ["No", "Yes Of Course", "What", "Anais"] ) );
